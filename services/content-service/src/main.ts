...
async function bootstrap(): Promise<void> {
  // bufferLogs retiene los mensajes del arranque hasta que pino esta listo;
  // sin esto, las primeras lineas salen con el formato por defecto de Nest y
  // rompen el JSON del log justo en el momento mas util para depurar.
