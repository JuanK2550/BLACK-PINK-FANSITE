...
/**
 * Curiosidades y récords, en filas editoriales.
 *
 * Se piden solo las de categoría RECORD: son las que explican el alcance del
 * grupo y las que justifican una sección en la portada.
 */
      ...
      <ul className="mt-block">
        {facts.map((fact) => (
          ...
          >
            ...
            {/* La fuente se muestra, no se esconde: es lo que separa este sitio
                de una cuenta de curiosidades. */}
