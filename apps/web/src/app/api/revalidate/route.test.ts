...
/**
 * La ruta de revalidación: que se abra solo con el secreto bueno, y que cuando
 * se abre tire de verdad las etiquetas y el layout.
 */
...
describe('POST /api/revalidate', () => {
  ...
  it('con el marcador de .env.example sin cambiar, la ruta sigue cerrada', async () => {
    // «cambia-esto-tambien» está publicado en el repositorio: no es un secreto.
  ...
  it('con el secreto bueno tira las etiquetas Y el layout', async () => {
    ...
    // Solo el layout dejaría viva la caché de `fetch`, y la página se
    // regeneraría con los datos de antes.
