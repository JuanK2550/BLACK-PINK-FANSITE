 ...
 *
 * En móvil es vertical y en escritorio horizontal, pero NO son dos árboles con
 * `hidden` cruzados: es la misma lista, y lo que cambia es la dirección del
 * flex y la línea guía. Duplicar el marcado duplicaría también el contenido
 * para los lectores de pantalla, que leerían cada hito dos veces.
 *
 * Las tarjetas se despliegan con `<button aria-expanded>`, no con un div y un
 * onClick: así funcionan con teclado y se anuncian correctamente.
 * ============================================================================
 */
  ...
  return (
    <>
      ...
      {visible.length === 0 ? (
        ...
        /*
         * `-mx-gutter` + `overflow-x-auto` solo en escritorio: el rail se
         * desplaza dentro de su caja y el cuerpo de la página nunca hace
         * scroll horizontal, ni a 320px.
         */
        <div className="mt-block lg:-mx-gutter lg:px-gutter lg:overflow-x-auto lg:pb-4">
          <ol className="relative flex flex-col gap-0 lg:min-w-max lg:flex-row lg:gap-8 lg:pt-10">
            {/* La línea guía: vertical en móvil, horizontal en escritorio. */}
            <span
              aria-hidden="true"
