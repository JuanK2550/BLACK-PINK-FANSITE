...
/**
 * Curiosidades, records y datos sueltos.
 *
 * El reparto entre verified true y false NO es casual: solo va como verificado
 * lo que es estable y esta ampliamente documentado. Todo lo que depende de una
 * cifra concreta, de una fecha exacta o de una declaracion puntual entra como
 * no verificado, aunque me suene cierto. La instruccion del proyecto es clara:
 * antes marcarlo que inventarlo.
 *
 * El sitio publica por defecto solo las entradas con verified: true.
 */
