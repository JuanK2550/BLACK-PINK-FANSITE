...
/**
 * ============================================================================
 * E2E DEL FLUJO DE CHAT
 * ============================================================================
 * Levanta el stack HTTP entero -validacion, filtro de errores, SSE- y simula
 * unicamente la frontera externa: el proveedor de IA y el almacen vectorial.
 * Es la misma linea que en los otros servicios: se prueba nuestro codigo, no
 * el de Google ni el de Postgres.
 * ============================================================================
 */
