...
export interface QuizSeed {
  ...
  /** Indice de la respuesta correcta, base 0. El MISMO para los tres idiomas. */
  correctIndex: number;
  verified: boolean;
  source: string;
 ...
 *
 * 1. Toda pregunta sale de un dato marcado como verificado en trivia, en la
 *    discografia o en la cronologia. No se pregunta por nada que este
 *    pendiente de contrastar: un quiz que corrige con un dato dudoso ensena
 *    mal, y encima con autoridad.
 *
 * 2. Las opciones traducidas van en el MISMO orden en los tres idiomas.
 *    `correctIndex` se comparte, asi que reordenarlas romperia la correccion
 *    en los otros dos idiomas sin que salte ningun error.
 */
