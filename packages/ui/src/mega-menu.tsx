...
/**
 * Contenido de los mega-menus.
 *
 * El escalonado es decorativo y corto (40ms entre elementos): mas separacion
 * y el menu se siente lento justo cuando el usuario ya sabe donde va.
 */
const list = {
  hidden: {},
