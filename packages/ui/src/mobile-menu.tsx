 ...
 *
 * Entra con un barrido de clip-path de arriba abajo (curva iOS, 320ms) en vez
 * de un desvanecido: el panel se lee como una superficie que baja, no como una
 * capa que aparece de la nada. La salida es mas rapida que la entrada, porque
 * al cerrar el usuario ya ha decidido.
 */
export function MobileMenu({
  ...
  useEffect(() => {
    ...
    // El primer enfocable del panel es el boton de cerrar: es la salida.
