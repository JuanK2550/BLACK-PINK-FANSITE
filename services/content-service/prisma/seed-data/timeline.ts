...
export interface TimelineSeed {
  ...
  /** 1 a 5. Manda cuanto destaca el hito en la cronologia del sitio. */
  importance: number;
  /**
   * Precision REAL de la fecha. Cuando solo se conoce el mes se guarda el dia
   * 1 con precision 'month': guardar el dia 1 y callarlo seria inventar una
...
export const TIMELINE: TimelineSeed[] = [
  ...
  },
  {
    ...
    importance: 4,
    /*
     * MES, no dia. La fuente esta fechada el 31 de agosto de 2020 y habla de
     * la gala en pasado, asi que agosto de 2020 esta contrastado; el dia
     * exacto de la ceremonia no lo dice ninguna de las dos fuentes y no se
     * deduce de la fecha de publicacion de una noticia.
     */
    datePrecision: 'month',
    verified: true,
    source:
