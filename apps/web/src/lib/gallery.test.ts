...
/**
 * Los datos de la galeria.
 *
 * Aqui se prueban DOS cosas distintas. Las funciones puras, con datos
 * inventados; y el volcado real, con afirmaciones sobre lo que el proyecto se
 * ha comprometido a publicar: solo licencias libres, medidas presentes y
 * ninguna imagen ampliada. Ese segundo bloque es el que convierte una promesa
 * escrita en CLAUDE.md en algo que falla si alguien la rompe.
 */
...
describe('el volcado real', () => {
  ...
  it('SOLO licencias libres', () => {
    // Es la promesa que hace posible publicarlas. Si alguien mete una foto con
    // otra licencia, este test cae antes que el pull request.
  ...
  it('todas traen autor, origen y medidas', () => {
    // Sin autor no se puede atribuir; sin medidas la rejilla salta al cargar.
  ...
  it('ninguna pesa mas de 700 KB', () => {
    // Una galeria es donde mas facil se hunde el LCP.
