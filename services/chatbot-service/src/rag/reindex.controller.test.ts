...
/**
 * Las reglas del reindexado bajo demanda. Un endpoint de administracion que
 * se equivoca en su proteccion es peor que no tenerlo.
 */
...
describe('ReindexController', () => {
  ...
  it('con el marcador de .env.example sin cambiar, tambien 404', () => {
    // «cambia-esto-por-un-secreto...» es texto de ejemplo, y hay despliegues
    // que lo dejan tal cual. Menos de 24 caracteres no se acepta como secreto.
